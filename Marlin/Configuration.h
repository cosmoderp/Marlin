...
//#define RELATIVE_MODE  // for ender3 v2 -- Makes the Move menu Relative instead of absolute positions
#define PERSISTENT_MANUAL_LEVELING // for ender3 v2 -- keeps manual option leveling when using probe
//
